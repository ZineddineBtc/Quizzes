...
public class ProfileQuizzesAdapter extends RecyclerView.Adapter<ProfileQuizzesAdapter.ViewHolder> {
    ...
    public ProfileQuizzesAdapter(Context context, List<Quiz> quizList) {
